...
export function buildCompanyIntelligenceProfile(
  ...
  return {
    ...
    ...(input.context.website ? { website: input.context.website } : {}),
    ...(input.industry ?? input.context.industry
      ? { industry: input.industry ?? input.context.industry }
      : {}),
    ...(input.subIndustry ? { subIndustry: input.subIndustry } : {}),
    ...(input.headquarters ? { headquarters: input.headquarters } : {}),
    geographies: unique(input.context.markets),
    ...(input.employeeBand ? { employeeBand: input.employeeBand } : {}),
    ...(input.revenueBand ? { revenueBand: input.revenueBand } : {}),
