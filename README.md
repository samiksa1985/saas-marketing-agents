...
**An open-source AI marketing team for B2B SaaS — 71 specialist agents, one orchestrator, real playbooks.**

Install a full B2B SaaS marketing org into Claude Code: 71 role-based agent personas, packaged as **19 skills**, coordinated by the **CATALYST** multi-agent orchestrator — with worked ABM, launch & demand-gen workflows and an actively-maintained **AEO/GEO** playbook for the AI-search era.
...
[![Agents](https://img.shields.io/badge/agents-71-blue)](AGENTS_INDEX.md)
...
[Quick start](#-quick-start) · [The 71 agents](#-the-team-71-specialist-agents) · [Skills](#-skills) · [CATALYST](#️-catalyst-orchestrator) · [Loops](#-marketing-loops) · [AEO/GEO](#-built-for-ai-search-aeogeo) · [Contributing](#-contributing)
...
_These 17 disciplines hold all 71 specialist agents. On top sits the **[CATALYST orchestrator](#️-catalyst-orchestrator)**, which coordinates them._
...
|-------|--------|-------------|
| **CATALYST Orchestrator** | all 71 | "GTM launch", "campaign plan", "marketing strategy" |
...
| **Marketing Analytics** | 5 | "CRO", "A/B testing", "dashboards", "attribution", "tracking plan", "GA4 audit" |
