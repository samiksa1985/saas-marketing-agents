...
This guide shows how to use SaaS Marketing Agents with your favorite AI coding tools. All 71 agents are plain Markdown with YAML frontmatter, so they port across these platforms — but each tool has its own rules/agents convention, and the sections below give the current one for each.
